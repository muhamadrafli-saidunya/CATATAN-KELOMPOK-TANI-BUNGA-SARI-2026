...
export const downloadPanenExcelTemplate = (
  ...
  const defaultPetaniSamples = (petaniList && petaniList.length >= 4)
    ? [
        { nama: petaniList[0].nama, blok: petaniList[0].blokLahan },
        { nama: petaniList[1].nama, blok: petaniList[1].blokLahan },
        { nama: petaniList[2].nama, blok: petaniList[2].blokLahan },
        { nama: petaniList[3].nama, blok: petaniList[3].blokLahan },
      ]
    : [
        { nama: 'H. Ridwan Santoso', blok: 'Blok A-01 (Kavling Utama)' },
        { nama: 'Slamet Riyadi', blok: 'Blok A-02 & A-03' },
        { nama: 'I Wayan Sudarma', blok: 'Blok B-02 & B-04' },
        { nama: 'Joko Susilo', blok: 'Blok B-01' },
      ];

  const defaultHarga = pengaturan?.hargaTbsDefault || 2780;
  const defaultPks = pengaturan?.namaPksDefault || 'PT. Sawit Sejahtera Tapung';
  ...
  const samplePanenData = [
    {
      ...
      'Nama Petani': defaultPetaniSamples[0].nama,
      'Blok Lahan': defaultPetaniSamples[0].blok,
      'Timbangan Kebun (Kg)': 5420,
      'Timbangan Pabrik (Kg)': 5360,
      'Harga TBS (Rp/Kg)': defaultHarga,
      'Potongan Pedaran (Kg)': 0,
      'Iuran Kas (Rp)': 0,
      'Upah Panen (Rp)': 0,
      'Kasbon Pupuk (Rp)': 0,
      'PKS Tujuan': defaultPks,
    ...
    },
    {
      ...
      'No SPB': 'SPB-2026-002',
      'Tanggal Panen': '2026-08-25',
      'Nama Petani': defaultPetaniSamples[1].nama,
      'Blok Lahan': defaultPetaniSamples[1].blok,
    ...
    },
    {
      ...
      'No SPB': 'SPB-2026-003',
      'Tanggal Panen': '2026-08-25',
      'Nama Petani': defaultPetaniSamples[2].nama,
      'Blok Lahan': defaultPetaniSamples[2].blok,
    ...
    },
    {
      ...
      'No SPB': 'SPB-2026-004',
      'Tanggal Panen': '2026-08-25',
      'Nama Petani': defaultPetaniSamples[3].nama,
      'Blok Lahan': defaultPetaniSamples[3].blok,
